...
Anti_matter_Equation = {"NAME":"反物质方程", "ATE":ATE[0], "FY":1, "E":0.1, "PE":0.25, "APM":2.5}
                
Annihilation_Equation = {"NAME":"湮灭方程", "ATE":ATE[0], "FY":1, "E":0.1, "PE": 0.5, "APM":2.7}
                
Distance_Movement_Equation = {"NAME":"跃迁方程", "ATE":ATE[1], "FY":6, "E":0.1, "PE":0.25, "APM":0.7}

Distance_Movement_Penetration = {"NAME":"跃迁穿透", "ATE":ATE[1], "FY":1, "E":0.25, "PE":0.1, "APM":2.95}
                
Super_Anti_matter_Equation = {"NAME":"终极反物质方程", "ATE":ATE[0], "FY":1, "APM":3.0}
        
Super_Annihilation_Equation = {"NAME":"终极湮灭方程", "ATE":ATE[0], "FY":1, "APM":3.25}
        
Super_Distance_Movement_Equation = {"NAME":"终级跃迁方程", "ATE":ATE[1], "FY":8, "APM":0.85}

Super_Distance_Movement_Penetration = {"NAME":"究极跃迁穿透", "ATE":ATE[1], "FY":1, "APM":3.65}
